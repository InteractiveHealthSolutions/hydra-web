...
// *
// * Copyright (C) OpenMRS Inc. OpenMRS is a registered trademark and the
/// OpenMRS
...
//
/// **
// * This is a unit test, which verifies logic in HydraService. It doesn't
/// extend
// * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and
/// Spring context.
// */
...
// assertThat(hydraFrom, hasProperty("actionsXml",
/// is(hydraFrom.getActionsXML())));
// }
// }
