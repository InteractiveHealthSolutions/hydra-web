...
public interface HydraService extends OpenmrsService {
	...
	// @Authorized()
	// @Transactional(readOnly = true)
	// HydraForm getHydraFormByEncounterName(String encunterName) throws
	// APIException;
	...
	// @Authorized(HydraConfig.MODULE_PRIVILEGE)
	// @Transactional
	// HydramoduleForm saveHydramoduleForm(HydramoduleForm item) throws
	// APIException;
	//
	// @Authorized()
	// @Transactional(readOnly = true)
	...
	//
	// /**
	// * Returns a set of {@link org.openmrs.module.hydra.model.HydraForm} by tag.
	...
	// HydramoduleComponent saveComponent(HydramoduleComponent component) throws
	// APIException;

	// HydramoduleWorkflow saveWorkflow(HydramoduleWorkflow item) throws
	// APIException;
	//
	// public HydramoduleWorkflowPhases
	// saveWorkflowPhaseRelation(HydramoduleWorkflowPhases item) throws
	// APIException;

	// public HydramodulePhaseComponents
	// savePhaseComponentRelation(HydramodulePhaseComponents item) throws
	// APIException;

	// HydramoduleWorkflow getWorkflowByUUID(String uuid) throws APIException;
	//
	// HydramoduleWorkflowPhases getWorkflowPhasesRelationByUUID(String uuid) throws
	// APIException;

	// HydramodulePhaseComponents getPhasesComponentRelationByUUID(String uuid)
	// throws APIException;

	// List<HydramoduleWorkflow> getAllWorkflows() throws APIException;
	//
	// List<HydramoduleWorkflowPhases> getAllWorkflowPhaseRelations() throws
	// APIException;

	// List<HydramodulePhaseComponents> getAllPhaseComponentsRelations() throws
	// APIException;
	...
	// void deletePhaseComponent(HydramodulePhaseComponents phaseComponent) throws
	// APIException;

	// void deleteWorkflowPhase(HydramoduleWorkflowPhases workflowphases) throws
	// APIException;
	//
	...
	// HydramoduleService saveService(HydramoduleService service) throws
	// APIException;
	//
	...
	//
	// HydramoduleServiceType saveServiceType(HydramoduleServiceType form) throws
	// APIException;
	//
	// List<HydramoduleServiceType> getAllServiceTypes(boolean retired) throws
	// APIException;
	//
	// HydramoduleServiceType getServiceType(String uuid) throws APIException;

	// HydramoduleAssetType saveAssetType(HydramoduleAssetType service) throws
	// APIException;
	//
	// List<HydramoduleAssetType> getAllAssetTypes(boolean retired) throws
	// APIException;
	//
	// HydramoduleAssetType getAssetType(String uuid) throws APIException;
	//
	// HydramoduleAssetCategory saveAssetCategory(HydramoduleAssetCategory service)
	// throws APIException;
	//
	// List<HydramoduleAssetCategory> getAllAssetCategories(boolean retired) throws
	// APIException;
	//
	...
	// HydramoduleParticipant saveParticipant(HydramoduleParticipant service) throws
	// APIException;
	//
	// List<HydramoduleParticipant> getAllParticipants(boolean retired) throws
	// APIException;
	//
	// HydramoduleParticipant getParticipant(String uuid) throws APIException;
	//
	// HydramoduleParticipantSalaryType
	// saveParticipantSalaryType(HydramoduleParticipantSalaryType service) throws
	// APIException;
	//
	// List<HydramoduleParticipantSalaryType> getAllParticipantSalaryTypes(boolean
	// retired) throws APIException;
	//
	// HydramoduleParticipantSalaryType getParticipantSalaryType(String uuid) throws
	// APIException;
	...
	//
	// HydramoduleEventSchedule saveEventSchedule(HydramoduleEventSchedule service)
	// throws APIException;
	//
	// List<HydramoduleEventSchedule> getAllEventSchedules(boolean voided) throws
	// APIException;
	//
	// HydramoduleEventSchedule getEventSchedule(String uuid) throws APIException;
	//
	// HydramoduleEventType saveEventType(HydramoduleEventType service) throws
	// APIException;
	//
	// List<HydramoduleEventType> getAllEventTypes(boolean voided) throws
	// APIException;
	//
	// HydramoduleEventType getEventType(String uuid) throws APIException;
	//
	// HydramoduleEventService saveEventService(HydramoduleEventService service)
	// throws APIException;
	//
	// List<HydramoduleEventService> getAllEventServices(boolean voided) throws
	// APIException;
	//
	// HydramoduleEventService getEventService(String uuid) throws APIException;
	//
	// HydramoduleEventAsset saveEventAsset(HydramoduleEventAsset service) throws
	// APIException;
	//
	// List<HydramoduleEventAsset> getAllEventAssets(boolean voided) throws
	// APIException;
	//
	// HydramoduleEventAsset getEventAsset(String uuid) throws APIException;
	//
	// HydramoduleEventParticipants
	// saveEventParticipant(HydramoduleEventParticipants service) throws
	// APIException;
	//
	// List<HydramoduleEventParticipants> getAllEventParticipants(boolean voided)
	// throws APIException;
	//
	// HydramoduleEventParticipants getEventParticipant(String uuid) throws
	// APIException;

	// List<HydramoduleForm> getAllModuleFormsByComponent(String componentUUID)
	// throws APIException;
	...
	// HydramoduleComponentForm saveComponentFormRelation(HydramoduleComponentForm
	// item) throws APIException;
	//
	// HydramoduleComponentForm getComponentFormByUUID(String uuid) throws
	// APIException;
	//
	// List<HydramoduleComponentForm> getAllComponentFormsRelations() throws
	// APIException, CloneNotSupportedException;
	//
	// void retireComponentForm(HydramoduleComponentForm phaseComponent) throws
	// APIException;

	// HydramoduleField saveHydramoduleField(HydramoduleField service) throws
	// APIException;
	//
	...
	//
	// HydramoduleFieldAnswer getHydramoduleFieldAnswer(String uuid) throws
	// APIException;
	//
	// List<HydramoduleFieldAnswer> getAllHydramoduleFieldAnswers(boolean voided)
	// throws APIException;
	//
	// HydramoduleFieldAnswer saveHydramoduleFieldAnswer(HydramoduleFieldAnswer
	// service) throws APIException;
	//
	// List<HydramoduleField> getHydramoduleFieldsByName(String queryParam);
	//
	// HydramoduleFieldRule saveHydramoduleFieldRule(HydramoduleFieldRule service)
	// throws APIException;
	//
	// List<HydramoduleFieldRule> getAllHydramoduleFieldRules(boolean voided) throws
	// APIException;
	//
	// HydramoduleFieldRule getHydramoduleFieldRule(String uuid) throws
	// APIException;
	//
	// HydramoduleRuleToken saveHydramoduleRuleToken(HydramoduleRuleToken service)
	// throws APIException;
	//
	// List<HydramoduleRuleToken> getAllHydramoduleRuleTokens() throws APIException;
	//
	// HydramoduleRuleToken getHydramoduleRuleToken(String uuid) throws
	// APIException;
	//
	// void saveFormEncounter(HydramoduleFormEncounter formEncounter);

	// List<HydramoduleParticipant> getParticipantByUserUUID(String userUUID) throws
	// APIException;

	/// HydramodulePatientWorkflow
	/// saveHydramodulePatientWorkflow(HydramodulePatientWorkflow service) throws
	/// APIException;

	// List<HydramodulePatientWorkflow> getAllHydramodulePatientWorkflows() throws
	// APIException;

	// HydramodulePatientWorkflow getHydramodulePatientWorkflow(String uuid) throws
	// APIException;

	// HydramoduleFormField getFormFieldByUUID(String uuid) throws APIException;

	// HydramoduleUserWorkflow saveHydramoduleUserWorkflow(HydramoduleUserWorkflow
	// hydramoduleUserWorkflow) throws APIException;
	//
	// List<HydramoduleUserWorkflow> getAllHydramoduleUserWorkflow() throws
	// APIException;
	//
	// List<HydramoduleUserWorkflow> getUserWorkflowByUser(String uuid) throws
	// APIException;
	//
	// HydramoduleUserWorkflow getHydramoduleUserWorkflow(String uuid) throws
	// APIException;
	//
	...
	// HydramodulePatientWorkflow getHydramodulePatientWorkflowByPatient(Integer
	// patientId) throws APIException;

	// List<HydramodulePhaseComponents>
	// getHydramodulePhaseComponentsByWorkflow(String uuid) throws APIException;

	// List<HydramoduleWorkflowPhases> getWorkflowPhaseByWorkflow(String
	// workflowUUID) throws APIException;

	// List<HydramoduleComponentForm> getComponentFormsByComponent(String
	// componentUUID) throws APIException;

	// List<HydramoduleFormField> getFormFieldsByForm(String uuid) throws
	// APIException;
