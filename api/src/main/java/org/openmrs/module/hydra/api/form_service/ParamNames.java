...
public class ParamNames {
	...
	public static final String PAT_NAME = "PATIENT_NAME";
	...
	public static final String PATIENTMH_ID = "MH ID";
	...
	public static final byte[] KEY_VALUE = new byte[] { 'T', 'h', 'e', 'B', 'e', 's', 't', 'S', 'e', 'c', 'r', 'e', 't',
	        'K', 'e', 'y' };
